...
@NamedQueries({
              ...
              @NamedQuery(name = "Dmjlogin.findByName", query = "select o from Dmjlogin o where o.usuario = :name "),
              @NamedQuery(name = "Dmjlogin.findByNameAndPass",
                          query = "select o from Dmjlogin o where o.contraseña = :name ")
    })
