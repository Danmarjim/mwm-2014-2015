...
@Stateless(name = "SessionEJB", mappedName = "EJB-Evaluacion-SessionEJB")
@Local
public class LoginFacade implements ILoginFacade {
    ...
    @Override
    public List<Dmjlogin> getDmjloginFindByName(String name) {
        Query query = em.createNamedQuery("Dmjlogin.findByName", Dmjlogin.class);
        query.setParameter("name", name);
        return query.getResultList();
    }
    
    public List<Dmjlogin> getDmjloginFindByNameAndPass(String name){
        Query query = em.createNamedQuery("Dmjlogin.findByName", Dmjlogin.class);
        query.setParameter("name", name);
        return query.getResultList();
    }
